...
class AccCreator(threading.Thread):
    def __init__(self, proxy):
        ...
        self.username: str = f'xKian_{str(binascii.b2a_hex(os.urandom(8)).decode("utf-8"))}'
    ...
    def start(self):
        ...
        headers: dict = {
            ...
            'guilded-client-id': f'{str(binascii.b2a_hex(os.urandom(8)).decode("utf-8"))}-{str(binascii.b2a_hex(os.urandom(4)).decode("utf-8"))}-{str(binascii.b2a_hex(os.urandom(4)).decode("utf-8"))}-{str(binascii.b2a_hex(os.urandom(4)).decode("utf-8"))}-{str(binascii.b2a_hex(os.urandom(12)).decode("utf-8"))}',
        ...
        try:
            with httpx.Client(proxies=self.proxy, headers=headers) as client:
